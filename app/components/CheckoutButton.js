  ...
  return (
    <>
      <button
        ...
        className="text-2xl font-medium uppercase mb-8 px-5 py-4 rounded-md bg-sky-500 hover:bg-sky-800 mt-4"
      >
        Checkout
      </button>
                ...
                <div className="mt-4">
                  {product ? (
                    <p className="text-lg text-gray-700">
                      You have purchased {currentQuantity} of {product.product} for GHS {totalAmount}.
                    </p>
                  ) : (
                    <p className="text-lg text-gray-700">
